...
class Usuario(AbstractBaseUser,PermissionsMixin):
    ...
    image = models.ImageField('Imagen de Perfil',upload_to='perfil/',blank = True,null = True)#,max_lenght=200
    ...
    class Meta:
        permissions = [('permiso_desde_codigo','Este es un permiso creado desde codigo'),('segundo_permiso_codigo','Segundo permiso creado desde codigo')]
